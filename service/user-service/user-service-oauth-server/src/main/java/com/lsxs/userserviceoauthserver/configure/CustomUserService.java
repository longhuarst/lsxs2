...
import com.lsxs.userserviceoauthserver.repository.UserRepository;
import com.lsxs.userserviceoauthserver.util.UserJwt;
...
//    private UserFeign userFeign;
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        Optional<com.lsxs.userserviceoauthserver.entity.User> user = null;
        try{
//            user = userFeign.findByUsername(username).getData();
            com.lsxs.userserviceoauthserver.entity.User exampleUser = new  com.lsxs.userserviceoauthserver.entity.User();
            exampleUser.setUsername(username);
            user = userRepository.findOne(Example.of(exampleUser));
